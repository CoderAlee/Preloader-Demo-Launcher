 ...
 *
 *********************************************************/
class TestEInitializer implements IInitializer {
    @Override
    ...
    public List<Class<? extends IInitializer>> getDependencies(@NonNull int pid, @NonNull String processName) {
        ...
        dependencies.add(TestHInitializer.class);
        dependencies.add(TestCInitializer.class);
        dependencies.add(TestIInitializer.class);
        return dependencies;
    }
