 ...
 *
 *********************************************************/
class TestDInitializer implements IInitializer {
    @Override
    ...
    public List<Class<? extends IInitializer>> getDependencies(@NonNull int pid, @NonNull String processName) {
        ...
        dependencies.add(TestEInitializer.class);
        dependencies.add(TestFInitializer.class);
        dependencies.add(TestGInitializer.class);
        return dependencies;
    }
